...
![image-left]({{ '/example/images/true_shooting_precentage_table.png' | absolute_url }}){: .align-left} 
...
![image-left]({{ '/example/images/how_do_we_calculate_TS.png' | absolute_url }}){: .align-left} 
...
![image-left]({{ '/example/images/The_best_true_shooting_players_over_the_last_25_seasons.png' | absolute_url }}){: .align-left} 
...
![image-left]({{ '/example/images/gp_table.png' | absolute_url }}){: .align-left}
...
In addition we can notice the high percentage of each player's games played over the entire season. For example: For 9 years,  **Damian Lillard** has an average game played in a season of almost 76 games. This result reflects **91.30%** ( 76/83) games all his career. 
...
![image-left]({{ '/example/images/Total_games_played_by_a_player_over_this_NBA_career.png' | absolute_url }}){: .align-left}




![image-left]({{ '/example/images/
